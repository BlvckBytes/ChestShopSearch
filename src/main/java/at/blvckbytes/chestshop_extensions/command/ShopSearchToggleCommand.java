...
import at.blvckbytes.chestshop_extensions.NameScopedKeyValueStore;
...
public class ShopSearchToggleCommand implements CommandExecutor {
  ...
  private @Nullable ProtectedRegion locateOwnedShopRegion(Player player) {
    ...
    for (var region : regions) {
      ...
      if (!region.isOwner(worldGuardPlayer) && !player.hasPermission("chestshopextensions.toggle.bypass"))
        continue;
